...
public class AllJoynService extends Service implements Observer {
    ...
    class ChatService implements ChatInterface, BusObject {
    	...
    	public void Advertize(String str) throws BusException {
    	}
    }
    ...
    public void Chat(String string) {
        ...
        if(string.contains("Info")){
        	...
        	while(m.find()){
        		Log.d(TAG, m.group());
        		mChatApplication.getHashtable().put( m.group(), nickname);
        		if(mChatApplication.getHashtable().containsValue(nickname)){
        			Log.d(TAG, m.group());
        		}
        	}
